  ...
  return (
    <aside className="hidden lg:flex w-72 bg-green-950 text-white flex-col p-6">
      ...
      <nav className="space-y-2 flex-1">
        ...
        <SidebarItem icon={<FileText size={20} />} label="Waste Reports" active={activeSection === "reports"} onClick={() => setActiveSection("reports")} />
        ...
        <SidebarItem icon={<BarChart3 size={20} />} label="Waste Analytics" active={activeSection === "analytics"} onClick={() => setActiveSection("analytics")} />
        <SidebarItem icon={<Recycle size={20} />} label="Collection Map" active={activeSection === "map"} onClick={() => setActiveSection("map")} />
        <SidebarItem icon={<Trophy size={20} />} label="Leaderboard" active={activeSection === "leaderboard"} onClick={() => setActiveSection("leaderboard")} />
        <SidebarItem icon={<Users size={20} />} label="Manage Users" active={activeSection === "users"} onClick={() => setActiveSection("users")} />
      </nav>
